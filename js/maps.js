...
am4internal_webpackJsonp(["cc1e"], {
    QJ7E: function (t, e, n) {
        ...
        var S = 1e-6, _ = 1e-12, M = Math.PI, x = M / 2, j = M / 4, O = 2 * M, w = 180 / M, L = M / 180, C = Math.abs,
            E = Math.atan, I = Math.atan2, T = Math.cos, G = Math.ceil, D = Math.exp, N = (Math.floor, Math.log),
            z = Math.pow, V = Math.sin, A = Math.sign || function (t) {
                return t > 0 ? 1 : t < 0 ? -1 : 0
            }, F = Math.sqrt, R = Math.tan;
        ...
        var J, K, Q, $, tt, et = function (t, e) {
            ...
            point: W, lineStart: W, lineEnd: W, polygonStart: function () {
                ...
                var t = +nt;
                it.add(t < 0 ? O + t : t), this.lineStart = this.lineEnd = this.point = W
            }, sphere: function () {
                it.add(O)
            }
        };
        ...
        function ut(t, e) {
            rt.point = st, J = t, K = e, Q = t *= L, $ = T(e = (e *= L) / 2 + j), tt = V(e)
        }

        function st(t, e) {
            e = (e *= L) / 2 + j;
            var n = (t *= L) - Q, i = n >= 0 ? 1 : -1, r = i * n, o = T(e), a = V(e), u = tt * a, s = $ * o + u * T(r),
                c = u * i * V(r);
        ...
        var mt, yt, bt, Pt, St, _t, Mt, xt, jt, Ot, wt = m(), Lt = {
            point: Ct, lineStart: It, lineEnd: Tt, polygonStart: function () {
                Lt.point = Gt, Lt.lineStart = Dt, Lt.lineEnd = Nt, wt.reset(), rt.polygonStart()
            }, polygonEnd: function () {
                rt.polygonEnd(), Lt.point = Ct, Lt.lineStart = It, Lt.lineEnd = Tt, nt < 0 ? (mt = -(bt = 180), yt = -(Pt = 90)) : wt > S ? Pt = 90 : wt < -S && (yt = -90), Ot[0] = mt, Ot[1] = bt
            }, sphere: function () {
                mt = -(bt = 180), yt = -(Pt = 90)
            }
        };
        ...
        function Et(t, e) {
            ...
            if (xt) {
                ...
                vt(r), r = lt(r);
                var o, a = t - St, u = a > 0 ? 1 : -1, s = r[0] * w * u, c = C(a) > 180;
                c ^ (u * St < s && s < u * t) ? (o = r[1] * w) > Pt && (Pt = o) : c ^ (u * St < (s = (s + 360) % 360 - 180) && s < u * t) ? (o = -r[1] * w) < yt && (yt = o) : (e < yt && (yt = e), e > Pt && (Pt = e)), c ? t < St ? zt(mt, t) > zt(mt, bt) && (bt = t) : zt(t, bt) > zt(mt, bt) && (mt = t) : bt >= mt ? (t < mt && (mt = t), t > bt && (bt = t)) : t > St ? zt(mt, t) > zt(mt, bt) && (bt = t) : zt(t, bt) > zt(mt, bt) && (mt = t)
        ...
        var Ft, Rt, kt, Bt, Ht, Wt, Zt, qt, Xt, Yt, Ut, Jt, Kt, Qt, $t, te, ee = function (t) {
            var e, n, i, r, o, a, u;
            if (Pt = bt = -(mt = yt = 1 / 0), jt = [], et(t, Lt), n = jt.length) {
                for (jt.sort(Vt), e = 1, o = [i = jt[0]]; e < n; ++e) At(i, (r = jt[e])[0]) || At(i, r[1]) ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]), zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0])) : o.push(i = r);
                for (a = -1 / 0, e = 0, i = o[n = o.length - 1]; e <= n; i = r, ++e) r = o[e], (u = zt(i[1], r[0])) > a && (a = u, mt = r[0], bt = i[1])
            }
            return jt = Ot = null, mt === 1 / 0 || yt === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[mt, yt], [bt, Pt]]
        }, ne = {
            sphere: W, point: ie, lineStart: oe, lineEnd: se, polygonStart: function () {
        ...
        function re(t, e, n) {
            kt += (t - kt) / ++Ft, Bt += (e - Bt) / Ft, Ht += (n - Ht) / Ft
        }
        ...
        function ae(t, e) {
            t *= L;
            var n = T(e *= L);
            Qt = n * T(t), $t = n * V(t), te = V(e), ne.point = ue, re(Qt, $t, te)
        }

        function ue(t, e) {
            t *= L;
            var n = T(e *= L), i = n * T(t), r = n * V(t), o = V(e),
                a = I(F((a = $t * o - te * r) * a + (a = te * i - Qt * o) * a + (a = Qt * r - $t * i) * a), Qt * i + $t * r + te * o);
            Rt += a, Wt += a * (Qt + (Qt = i)), Zt += a * ($t + ($t = r)), qt += a * (te + (te = o)), re(Qt, $t, te)
        }
        ...
        function he(t, e) {
            ...
            var n = T(e);
            Qt = n * T(t), $t = n * V(t), te = V(e), re(Qt, $t, te)
        }

        function pe(t, e) {
            t *= L;
            var n = T(e *= L), i = n * T(t), r = n * V(t), o = V(e), a = $t * o - te * r, u = te * i - Qt * o,
                s = Qt * r - $t * i, c = F(a * a + u * u + s * s), l = B(c), h = c && -l / c;
            Xt += h * a, Yt += h * u, Ut += h * s, Rt += l, Wt += l * (Qt + (Qt = i)), Zt += l * ($t + ($t = r)), qt += l * (te + (te = o)), re(Qt, $t, te)
        }

        var fe = function (t) {
            Ft = Rt = kt = Bt = Ht = Wt = Zt = qt = Xt = Yt = Ut = 0, et(t, ne);
            var e = Xt, n = Yt, i = Ut, r = e * e + n * n + i * i;
            return r < _ && (e = Wt, n = Zt, i = qt, Rt < S && (e = kt, n = Bt, i = Ht), (r = e * e + n * n + i * i) < _) ? [NaN, NaN] : [I(n, e) * w, B(i / F(r)) * w]
        }, de = function (t) {
            return function () {
                return t
            }
        ...
        function Pe(t, e) {
            var n = T(t), i = V(t), r = T(e), o = V(e);

            function a(t, e) {
                var a = T(e), u = T(t) * a, s = V(t) * a, c = V(e), l = c * n + u * i;
                return [I(s * r - l * o, u * n - c * i), B(l * r + s * o)]
            }

            return a.invert = function (t, e) {
                var a = T(e), u = T(t) * a, s = V(t) * a, c = V(e), l = c * r - s * o;
        ...
        var Se = function (t) {
            ...
            return t = me(t[0] * L, t[1] * L, t.length > 2 ? t[2] * L : 0), e.invert = function (e) {
        ...
        function _e(t, e, n, i, r, o) {
            if (n) {
                var a = T(e), u = V(e), s = i * n;
                null == r ? (r = e + i * O, o = e - s / 2) : (r = Me(a, r), o = Me(a, o), (i > 0 ? r < o : r > o) && (r += i * O));
                for (var c, l = r; i > 0 ? l > o : l < o; l -= s) c = lt([a, -u * T(l), -u * V(l)]), t.point(c[0], c[1])
            }
        }
        ...
        var xe = function () {
            ...
            function a() {
                var a = n.apply(this, arguments), u = i.apply(this, arguments) * L, s = r.apply(this, arguments) * L;
                return t = [], e = me(-a[0] * L, -a[1] * L, 0).invert, _e(o, u, s, 1), a = {
                    type: "Polygon",
                    coordinates: [t]
                }, t = e = null, a
            }
            ...
            if (t.forEach(function (t) {
                if (!((e = t.length - 1) <= 0)) {
                    ...
                    if (Oe(i, a)) {
                        ...
                        r.lineEnd()
                    } else u.push(n = new we(i, t, null, !0)), s.push(n.o = new we(i, null, n, !1)), u.push(n = new we(a, t, null, !1)), s.push(n.o = new we(a, null, n, !0))
                }
            }), u.length) {
        ...
        var Te = function (t, e) {
            var n = Ie(e), i = e[1], r = V(i), o = [V(n), -T(n), 0], a = 0, u = 0;
            Ee.reset(), 1 === r ? i = x + S : -1 === r && (i = -x - S);
            for (var s = 0, c = t.length; s < c; ++s) if (h = (l = t[s]).length) for (var l, h, p = l[h - 1], f = Ie(p), d = p[1] / 2 + j, g = V(d), v = T(d), m = 0; m < h; ++m, f = b, g = _, v = w, p = y) {
                var y = l[m], b = Ie(y), P = y[1] / 2 + j, _ = V(P), w = T(P), L = b - f, C = L >= 0 ? 1 : -1,
                    E = C * L, G = E > M, D = g * _;
                if (Ee.add(I(D * C * V(E), v * w + D * T(E))), a += G ? L + C * O : L, G ^ f >= n ^ b >= n) {
                    var N = ft(ht(p), ht(y));
                    vt(N);
                    var z = ft(o, N);
                    vt(z);
                    var A = (G ^ L >= 0 ? -1 : 1) * B(z[2]);
                    (i > A || i === A && (N[0] || N[1])) && (u += G ^ L >= 0 ? 1 : -1)
                }
            }
        ...
        var Ae = function (t, e, n, i) {
            return function (r) {
                var o, a, u, s = e(r), c = je(), l = e(c), h = !1, p = {
                    point: f, lineStart: g, lineEnd: v, polygonStart: function () {
                        ...
                        var t = Te(o, i);
                        a.length ? (h || (r.polygonStart(), h = !0), Le(a, Re, t, n, r)) : t && (h || (r.polygonStart(), h = !0), r.lineStart(), n(null, null, 1, r), r.lineEnd()), h && (r.polygonEnd(), h = !1), a = o = null
                    }, sphere: function () {
                ...
                function b() {
                    ...
                    } else f > 1 && 2 & s && p.push(p.pop().concat(p.shift())), a.push(p.filter(Fe))
                }
            ...
            return {
                lineStart: function () {
                    ...
                    C(s - M) < S ? (t.point(n, i = (i + a) / 2 > 0 ? x : -x), t.point(r, i), t.lineEnd(), t.lineStart(), t.point(u, i), t.point(o, i), e = 0) : r !== u && s >= M && (C(n - r) < S && (n -= r * S), C(o - u) < S && (o -= u * S), i = function (t, e, n, i) {
                        var r, o, a = V(t - n);
                        return C(a) > S ? E((V(e) * (o = T(i)) * V(n) - V(i) * (r = T(e)) * V(t)) / (r * o * a)) : (e + i) / 2
        ...
        var Be = function (t) {
            ...
            function a(t, n, i) {
                ...
                if (!(v < 0)) {
                    var m = F(v), y = gt(f, (-d - m) / g);
                    if (dt(y, p), y = lt(y), !i) return y;
                    var b, P = t[0], _ = n[0], x = t[1], j = n[1];
                    _ < P && (b = P, P = _, _ = b);
                    var O = _ - P, w = C(O - M) < S;
                    if (!w && j < x && (b = x, x = j, j = b), w || O < S ? w ? x + j > 0 ^ y[1] < (C(y[0] - P) < S ? x : j) : x <= y[1] && y[1] <= j : O > M ^ (P <= y[0] && y[0] <= _)) {
                        var L = gt(f, (-d + m) / g);
            ...
            return Ae(o, function (t) {
                ...
                return {
                    lineStart: function () {
                        ...
                        if (!e && (c = s = g) && t.lineStart(), g !== s && (!(f = a(e, d)) || Oe(e, f) || Oe(d, f)) && (d[0] += S, d[1] += S, g = o(d[0], d[1])), g !== s) l = 0, g ? (t.lineStart(), f = a(d, e), t.point(f[0], f[1])) : (f = a(e, d), t.point(f[0], f[1]), t.lineEnd()), e = f; else if (r && e && i ^ g) {
                            var m;
        ...
        function qe(t, e, n, i) {
            ...
            return function (a) {
                var s, c, l, h, p, f, d, g, v, m, y, b = a, P = je(), S = {
                ...
                function M(o, a) {
                    ...
                    if (c && l.push([o, a]), m) h = o, p = a, f = u, m = !1, u && (b.lineStart(), b.point(o, a)); else if (u && v) b.point(o, a); else {
                        var s = [d = Math.max(Ze, Math.min(We, d)), g = Math.max(Ze, Math.min(We, g))],
                            P = [o = Math.max(Ze, Math.min(We, o)), a = Math.max(Ze, Math.min(We, a))];
                        He(s, P, t, e, n, i) ? (v || (b.lineStart(), b.point(s[0], s[1])), b.point(P[0], P[1]), u || b.lineEnd(), y = !1) : u && (b.lineStart(), b.point(o, a), y = !1)
                    }
                    d = o, g = a, v = u
                }
        ...
        var Xe, Ye, Ue, Je = function () {
            ...
            sphere: W, point: W, lineStart: function () {
                Qe.point = tn, Qe.lineEnd = $e
            }, lineEnd: W, polygonStart: W, polygonEnd: W
        };

        function $e() {
            Qe.point = Qe.lineEnd = W
        }

        function tn(t, e) {
            Xe = t *= L, Ye = V(e *= L), Ue = T(e), Qe.point = en
        }

        function en(t, e) {
            t *= L;
            var n = V(e *= L), i = T(e), r = C(t - Xe), o = T(r), a = i * V(r), u = Ue * n - Ye * i * o,
                s = Ye * n + Ue * i * o;
            Ke.add(I(F(a * a + u * u), s)), Xe = t, Ye = n, Ue = i
        }
        ...
        var Pn, Sn, _n, Mn, xn = function (t, e) {
            var n = t[0] * L, i = t[1] * L, r = e[0] * L, o = e[1] * L, a = T(i), u = V(i), s = T(o), c = V(o),
                l = a * T(n), h = a * V(n), p = s * T(r), f = s * V(r), d = 2 * B(F(H(o - i) + a * s * H(r - n))),
                g = V(d), v = d ? function (t) {
                    var e = V(t *= d) / g, n = V(d - t) / g, i = n * l + e * p, r = n * h + e * f, o = n * u + e * c;
                    return [I(r, i) * w, I(o, F(i * i + r * r)) * w]
                } : function () {
                    return [n * w, i * w]
                };
            ...
            point: W, lineStart: W, lineEnd: W, polygonStart: function () {
                ...
                Ln.lineStart = Ln.lineEnd = Ln.point = W, On.add(C(wn)), wn.reset()
            }, result: function () {
                var t = On / 2;
                return On.reset(), t
            }
        ...
        var Gn = Ln, Dn = 1 / 0, Nn = Dn, zn = -Dn, Vn = zn;
        var An, Fn, Rn, kn, Bn = {
            point: function (t, e) {
                t < Dn && (Dn = t);
                t > zn && (zn = t);
                e < Nn && (Nn = e);
                e > Vn && (Vn = e)
            }, lineStart: W, lineEnd: W, polygonStart: W, polygonEnd: W, result: function () {
                var t = [[Dn, Nn], [zn, Vn]];
                return zn = Vn = -(Nn = Dn = 1 / 0), t
            }
        }, Hn = 0, Wn = 0, Zn = 0, qn = 0, Xn = 0, Yn = 0, Un = 0, Jn = 0, Kn = 0, Qn = {
            point: $n, lineStart: ti, lineEnd: ii, polygonStart: function () {
                ...
                var t = Kn ? [Un / Kn, Jn / Kn] : Yn ? [qn / Yn, Xn / Yn] : Zn ? [Hn / Zn, Wn / Zn] : [NaN, NaN];
                return Hn = Wn = Zn = qn = Xn = Yn = Un = Jn = Kn = 0, t
            }
        };
        ...
        ji.prototype = {
            constructor: ji, point: function (t, e) {
        ...
        var Ii = 16, Ti = T(30 * L), Gi = function (t, e) {
            return +e ? function (t, e) {
                function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
                    var m = c - i, y = l - r, b = m * m + y * y;
                    if (b > 4 * e && g--) {
                        var P = a + p, _ = u + f, M = s + d, x = F(P * P + _ * _ + M * M), j = B(M /= x),
                            O = C(C(M) - 1) < S || C(o - h) < S ? (o + h) / 2 : I(_, P), w = t(O, j), L = w[0],
                            E = w[1], T = L - i, G = E - r, D = y * T - m * G;
                        (D * D / b > e || C((m * T + y * G) / b - .5) > .3 || a * p + u * f + s * d < Ti) && (n(i, r, o, a, u, s, L, E, O, P /= x, _ /= x, M, g, v), v.point(L, E), n(L, E, O, P, _, M, c, l, h, p, f, d, g, v))
                    }
                }
        ...
        function Ni(t, e, n, i) {
            var r = T(i), o = V(i), a = r * t, u = o * t, s = r / t, c = o / t, l = (o * n - r * e) / t,
                h = (o * e + r * n) / t;
        ...
        function Vi(t) {
            ...
            return j.stream = function (t) {
                ...
                return arguments.length ? (M = null == t ? (_ = i = r = o = null, jn) : qe(_ = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]), E()) : null == _ ? null : [[_, i], [r, o]]
            }, j.scale = function (t) {
                ...
                return arguments.length ? (v = t[0] % 360 * L, m = t[1] % 360 * L, y = t.length > 2 ? t[2] % 360 * L : 0, C()) : [v * w, m * w, y * w]
            }, j.angle = function (t) {
        ...
        function Fi(t, e) {
            ...
            var r = 1 + n * (2 * i - n), o = F(r) / i;

            function a(t, e) {
                var n = F(r - 2 * i * V(e)) / i;
                return [n * V(t *= i), o - n * T(t)]
            }

            return a.invert = function (t, e) {
                var n = o - e;
                return [I(t, C(n)) / i * A(n), B((r - (t * t + n * n) * i * i) / (2 * i))]
            }, a
        }
        ...
        function Wi(t) {
            return function (e, n) {
                var i = F(e * e + n * n), r = t(i), o = V(r), a = T(r);
                return [I(e * o, i * a), B(i && n * o / i)]
            }
        }

        var Zi = Hi(function (t) {
            return F(2 / (1 + t))
        });
        Zi.invert = Wi(function (t) {
            return 2 * B(t / 2)
        });
        var qi = function () {
        ...
        function $i(t, e) {
            var n = T(t), i = t === e ? V(t) : N(n / T(e)) / N(Qi(e) / Qi(t)), r = n * z(Qi(t), i) / i;
            if (!i) return Ui;

            function o(t, e) {
                r > 0 ? e < -x + S && (e = -x + S) : e > x - S && (e = x - S);
                var n = r / z(Qi(e), i);
                return [n * V(i * t), r - n * T(i * t)]
            }

            return o.invert = function (t, e) {
                var n = r - e, o = A(i) * F(t * t + n * n);
                return [I(t, C(n)) / i * A(n), 2 * E(z(r / o, 1 / i)) - x]
            }, o
        }
        ...
        function ir(t, e) {
            var n = T(t), i = t === e ? V(t) : (n - T(e)) / (e - t), r = n / i + t;
            if (C(i) < S) return er;

            function o(t, e) {
                var n = r - e, o = i * t;
                return [n * V(o), r - n * T(o)]
            }

            return o.invert = function (t, e) {
                var n = r - e;
                return [I(t, C(n)) / i * A(n), r - A(i) * F(t * t + n * n)]
            }, o
        }

        var rr = function () {
            return Ai(ir).scale(131.154).center([0, 13.9389])
        }, or = 1.340264, ar = -.081106, ur = 893e-6, sr = .003796, cr = F(3) / 2;

        function lr(t, e) {
            var n = B(cr * V(e)), i = n * n, r = i * i * i;
        ...
        lr.invert = function (t, e) {
            ...
            return [cr * t * (or + 3 * ar * r + o * (7 * ur + 9 * sr * r)) / T(i), B(V(i) / cr)]
        };
        var hr = function () {
        ...
        var gr = function () {
            var t, e, n, i, r, o, a = 1, u = 0, s = 0, c = 1, l = 1, h = jn, p = null, f = jn;
            ...
            return o = {
                stream: function (t) {
                    ...
                    return arguments.length ? (f = null == i ? (p = t = e = n = null, jn) : qe(p = +i[0][0], t = +i[0][1], e = +i[1][0], n = +i[1][1]), d()) : null == p ? null : [[p, t], [e, n]]
                }, scale: function (t) {
        ...
        var Hr = function (t) {
            function e() {
                var e = t.call(this) || this;
                e.className = "MapPolygon", e.polygon = e.createChild(Cr.a), e.polygon.shouldClone = !1, e.polygon.applyOnClones = !0, e.setPropertyValue("precision", .5);
                var n = new p.a;
            ...
            return Object(c.c)(e, t), e.prototype.getFeature = function () {
                ...
                if (this.series) {
                    var e = this.series.chart.projection, n = e.d3Path;
        ...
        d.c.registeredClasses.MapPolygon = Hr;
        var Wr = n("vMqJ"), Zr = n("v9UT"), qr = n("Wglt"), Xr = function (t) {
            function e() {
                var e = t.call(this) || this;
        ...
        var Jr = n("FzPm"), Kr = n("GtDR"), Qr = n("8ZqG"), $r = function (t) {
            function e() {
                ...
                var n = new p.a;
                e.background.fillOpacity = .9, e.background.fill = n.getFor("background"), e.events.on("hit", e.moveToPosition, e, !1), e.events.on("maxsizechanged", e.updateMapSize, e, !1), e.seriesContainer = e.createChild(Or.a), e.seriesContainer.shouldClone = !1;
        ...
        var uo = function (t) {
            ...
            return Object(c.c)(e, t), e.prototype.getFeature = function () {
                ...
                get: function () {
                    ...
                    this._point = t, this._geoPoint = Vr(t), this.updateExtremes()
                }, enumerable: !0, configurable: !0
            }), Object.defineProperty(e.prototype, "multiPoint", {
                get: function () {
                    return [this._point]
                }, set: function (t) {
                    this._point = t[0], this._geoPoint = Vr(this._point), this.updateExtremes()
                }, enumerable: !0, configurable: !0
        ...
        var co = n("Rnbi"), lo = n("jfaP"), ho = n("tjMS"), po = function (t) {
            function e() {
                var e = t.call(this) || this;
                e._imageListeners = {}, e.className = "MapLine", e.createLine(), e.line.stroke = Object(Qr.c)(), e.line.parent = e, e.strokeOpacity = 1, e.setPropertyValue("precision", .1);
                var n = new p.a;
            ...
            return Object(c.c)(e, t), e.prototype.createLine = function () {
                ...
                get: function () {
                    ...
                    if (this.setPropertyValue("imagesToConnect", t, !0), this.handleImagesToConnect(), this.series) {
                        ...
                        n && n.series.each(function (t) {
                            t instanceof so && (t.isReady() || e._disposers.push(t.events.on("ready", e.handleImagesToConnect, e, !1)))
                        })
                    }
                }, enumerable: !0, configurable: !0
                ...
                if (this.multiLine) {
                    if (this.shortestDistance) e.projection.d3Projection.precision(this.precision), this.line.path = e.projection.d3Path(this.getFeature()); else {
                ...
                get: function () {
                    return this._lineObjects || (this._lineObjects = new Wr.e(new ao), this._lineObjects.events.on("inserted", this.handleLineObjectAdded, this, !1), this._disposers.push(new Wr.c(this._lineObjects)), this._disposers.push(this._lineObjects.template)), this._lineObjects
                }, enumerable: !0, configurable: !0
        ...
        var bo = n("zhwk"), Po = function (t) {
            ...
            function e() {
                ...
                n.visible = !1, n.inert = !0, n.resizable = !0, n.events.on("transformed", e.handleMapTransform, e, !1), n.events.on("doublehit", e.handleDoubleHit, e, !1), n.events.on("dragged", e.handleDrag, e, !1), n.zIndex = 0, n.dragWhileResize = !0, e.events.on("maxsizechanged", function (t) {
                ...
                }, e), r.events.on("doublehit", e.handleDoubleHit, e), r.focusable = !0, i.events.on("down", e.handleMapDown, e, !1), e.background.fillOpacity = 0, e._disposers.push(Object(bo.b)().body.events.on("keyup", function (t) {
            ...
            return Object(c.c)(e, t), e.prototype.handlePanDown = function (t) {
                ...
                if (!this.seriesContainer.isResized) {
                    if (Object(bo.b)().areTransformed([this.panSprite.interactions, this.seriesContainer.interactions])) return;
                ...
                if (t || (t = this.zoomGeoPoint), t && g.isNumber(t.longitude) && g.isNumber(t.latitude)) {
                    ...
                    if (a) {
                        ...
                        return !r && e < this.zoomLevel && this.centerMapOnZoomOut && e < 1.5 && (c = this.innerWidth / 2 - (this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) * e * this.scaleRatio, l = this.innerHeight / 2 - (this.seriesMaxTop + (this.seriesMaxBottom - this.seriesMaxTop) / 2) * e * this.scaleRatio), this._mapAnimation = this.seriesContainer.animate([{
                            property: "scale",
                            to: e
                ...
                if (r && r.done(), t instanceof Lr) return g.isNaN(e) && (e = 5), this.zoomToGeoPoint({
                    latitude: t.latitude,
                    longitude: t.longitude
                }, e, n, i, !0);
                var o = t.dataItem;
                if (o && g.isNumber(o.zoomLevel) && (e = o.zoomLevel), t instanceof Hr) {
                ...
                get: function () {
                    ...
                    t = v.round(t, 3), this.setPropertyValue("deltaLongitude", ro(t)) && (this.rotateMap(), this.updateZoomGeoPoint())
                }, enumerable: !0, configurable: !0
        ...
        var Do = Math.abs, No = Math.atan, zo = Math.atan2, Vo = (Math.ceil, Math.cos), Ao = Math.exp, Fo = Math.floor,
            Ro = Math.log, ko = Math.max, Bo = Math.min, Ho = Math.pow, Wo = (Math.round, Math.sign || function (t) {
                return t > 0 ? 1 : t < 0 ? -1 : 0
        ...
        ca.invert = function (t, e) {
            if (!(t * t + 4 * e * e > Uo * Uo + Xo)) {
                var n = t, i = e, r = 25;
                do {
                    var o, a = Zo(n), u = Zo(n / 2), s = Vo(n / 2), c = Zo(i), l = Vo(i), h = Zo(2 * i), p = c * c,
        ...
        function la(t, e) {
            var n = qo(e / 2), i = aa(1 - n * n), r = 1 + i * Vo(t /= 2), o = Zo(t) * i / r, a = n / r, u = o * o,
                s = a * a;
        ...
        la.invert = function (t, e) {
            ...
            var n = 1 + t * t + e * e, i = aa((n - aa(n * n - 4 * e * e)) / 2), r = ra(i) / 3, o = i ? function (t) {
                ...
                return Ro(t + aa(t * t + 1))
            }(Do(t)) / 3, a = Vo(r), u = sa(o), s = u * u - a * a;
            return [2 * Wo(t) * zo(ua(o) * a, .25 - s), 2 * Wo(e) * zo(u * Zo(r), .25 + s)]
        };
        var ha = aa(8), pa = Ro(1 + $o);

        function fa(t, e) {
            var n = Do(e);
            return n < Ko ? [t, Ro(qo(Ko + e / 2))] : [t * Vo(n) * (2 * $o - 1 / Zo(n)), Wo(e) * (2 * $o * (n - Ko) - Ro(qo(n / 2)))]
        }
        ...
        fa.invert = function (t, e) {
            ...
            var n, i, r = Ko, o = 25;
            do {
                var a = Vo(r / 2), u = qo(r / 2);
                r -= n = (ha * (r - Ko) - Ro(u) - i) / (ha - a * a / (2 * u))
            } while (Do(n) > Yo && --o > 0);
            return [t / (Vo(r) * (ha - 1 / Zo(r))), Wo(e) * r]
        };
        ...
        function ma(t, e, n) {
            ...
            return i.invert = function (i, r) {
                return r = ra(r / e), [i / (t * Vo(r)), ra((2 * r + Zo(2 * r)) / n)]
            }, i
        }

        var ya = ma($o / Jo, $o, Uo), ba = 2.00276, Pa = 1.11072;
        ...
        Sa.invert = function (t, e) {
            var n, i, r = ba * e, o = e < 0 ? -Ko : Ko, a = 25;
            do {
                i = r - $o * Zo(o), o -= n = (Zo(2 * o) + 2 * o - Uo * Zo(i)) / (2 * Vo(2 * o) + 2 + Uo * Vo(i) * $o * Vo(o))
            } while (Do(n) > Xo && --a > 0);
        ...
        function La(t, e) {
            ...
            return [2 / aa(6 * Uo) * t * n, Wo(e) * aa(2 * Uo / 3) * (2 - n)]
        }

        La.invert = function (t, e) {
            var n = 2 - Do(e) / aa(2 * Uo / 3);
            return [t * aa(6 * Uo) / (2 * n), Wo(e) * ra((4 - n * n) / 3)]
        };
        ...
        function Ea(t, e) {
            ...
            return [2 / aa(Uo * (4 + Uo)) * t * (1 + Vo(e)), 2 * aa(Uo / (4 + Uo)) * Zo(e)]
        }

        Ea.invert = function (t, e) {
            var n = e * aa((4 + Uo) / Uo) / 2, i = ra(n), r = Vo(i);
        ...
        function Ta(t, e) {
            for (var n = (1 + Jo) * Zo(e), i = 0, r = 1 / 0; i < 10 && Do(r) > Xo; i++) e -= r = (e + Zo(e) - n) / (1 + Vo(e));
        ...
        function Na(t, e) {
            var n = Zo(t /= 2), i = Vo(t), r = aa(Vo(e)), o = Vo(e /= 2), a = Zo(e) / (o + $o * i * r),
        ...
        Na.invert = function (t, e) {
            ...
            t /= Da, e /= Da;
            do {
                var a = i / 2, u = r / 2, s = Zo(a), c = Vo(a), l = Zo(u), h = Vo(u), p = Vo(r), f = aa(p),
                    d = l / (h + $o * c * f), g = d * d, v = aa(2 / (1 + g)),
                    m = ($o * h + (c + s) * f) / ($o * h + (c - s) * f), y = aa(m), b = y - 1 / y, P = y + 1 / y,
                    S = v * b - 2 * Ro(y) - t, _ = v * d * P - 2 * No(d) - e, M = l && Qo * f * s * g / l,
                    x = ($o * c * h + f) / (2 * (h + $o * c * f) * (h + $o * c * f) * f), j = -.5 * d * v * v * v,
                    O = j * M, w = j * x, L = (L = 2 * h + $o * f * (c - s)) * L * y, C = ($o * c * h * f + p) / L,
                    E = -$o * s * l / (f * L), I = b * O - 2 * C / y + v * (C + C / m),
                    T = b * w - 2 * E / y + v * (E + E / m),
                    G = d * P * O - 2 * M / (1 + g) + v * P * M + v * d * (C - C / m),
                    D = d * P * w - 2 * x / (1 + g) + v * P * x + v * d * (E - E / m), N = T * G - D * I;
                if (!N) break;
                var z = (_ * T - S * D) / N, V = (S * G - _ * I) / N;
            ...
            return arguments.length < 8 && (u = 0), s.invert = function (s, c) {
                ...
                do {
                    var g = f * f, v = t + g * (e + g * (n + g * i)), m = f * (r - 1 + g * (o - u + g * a)),
                        ...
                        j = (2 * e + g * (4 * n + 6 * g * i)) * f, O = r + g * (3 * o + 5 * g * a),
                        w = (2 * (v * j + m * (O - 1)) * b - y * (2 * (O - 1))) / (b * b), L = Vo(M), C = Zo(M),
                        E = P * L, I = P * C, T = p / Uo * (1 / aa(1 - x / S)) * (j * P - v * w) / S, G = I - s,
                        D = f * (1 + g * u) + P - E - c, N = w * C + E * T, z = E * _, V = 1 + w - (w * L - I * T),
                        A = I * _, F = N * A - V * z;
                    if (!F) break;
        ...
        Fa(2.8284, -1.6988, .75432, -.18071, 1.76003, -.38914, .042555), Fa(2.583819, -.835827, .170354, -.038094, 1.543313, -.411435, .082742), Fa(5 / 6 * Uo, -.62636, -.0344, 0, 1.3493, -.05524, 0, .045);
        ...
        function ka(t, e) {
            var n = Wo(t), i = Wo(e), r = Vo(e), o = Vo(t) * r, a = Zo(t) * r, u = Zo(i * e);
            ...
            var s = function (t, e) {
                ...
                var m, y = Vo(e), b = 1 / y, P = 2 * r * y, S = (-h * y - (-3 * o + l * s) * P * (1 - r)) / (h * h),
                ...
                if (t > .222 * Uo || e < Uo / 4 && t > .175 * Uo) {
                    ...
                    n = .5 * (w + O), i = 50;
                    do {
                        var L = aa(d - n * n), C = n * (x + _ * L) + M * ra(n / g) - j;
                        if (!C) break;
                        C < 0 ? w = n : O = n, n = .5 * (w + O)
                    } while (Do(O - w) > Xo && --i > 0)
                } else {
                    n = Xo, i = 25;
                    do {
                        var E = n * n, I = aa(d - E), T = x + _ * I, G = n * T + M * ra(n / g) - j,
                            D = T + (M - _ * E) / I;
                        n -= m = I ? G / D : 0
                    } while (Do(m) > Xo && --i > 0)
                }
        ...
        ka.invert = function (t, e) {
            Do(t) > 1 && (t = 2 * Wo(t) - t), Do(e) > 1 && (e = 2 * Wo(e) - e);
            var n = Wo(t), i = Wo(e), r = -n * t, o = -i * e, a = o / r < 1, u = function (t, e) {
                ...
                if (!o) return null;
                var m = ra(u), y = Vo(m), b = 1 / y, P = 2 * u * y,
                    S = (-c * y - (-3 * r + s * (1 + 3 * a)) * P * (1 - u)) / (c * c);
                return [Uo / 4 * (t * (-2 * b * (.5 * S / h * (1 - a) - 2 * r * h * P) + -b * P * g) + -b * (r * (1 + a) * S + l * (1 + 3 * a) * P) * ra(t / aa(p))), m]
            }(a ? o : r, a ? r : o), s = u[0], c = u[1], l = Vo(c);
            return a && (s = -Jo - s), [n * (zo(Zo(s) * l, -Zo(c)) + Uo), i * ra(Vo(s) * l)]
        };

        function Ba(t, e) {
            var n, i, r, o, a;
            if (e < Xo) return [(o = Zo(t)) - (n = e * (t - o * (i = Vo(t))) / 4) * i, i + n * o, 1 - e * o * o / 2, t - n];
            if (e >= 1 - Xo) return n = (1 - e) / 4, r = 1 / (i = sa(t)), [(o = function (t) {
                return ((t = Ao(2 * t)) - 1) / (t + 1)
            }(t)) + n * ((a = i * ua(t)) - t) / (i * i), r - n * o * r * (a - t), r + n * o * r * (a + t), 2 * No(Ao(t)) - Jo + n * (a - t) / i];
        ...
        function Wa(t, e) {
            var n = ($o - 1) / ($o + 1), i = aa(1 - n * n), r = Ha(Jo, i * i), o = Ro(qo(Uo / 4 + Do(e) / 2)),
                a = Ao(-1 * o) / aa(n), u = function (t, e) {
                    var n = t * t, i = e + 1, r = 1 - n - e * e;
                    return [.5 * ((t >= 0 ? Jo : -Jo) - zo(r, 2 * t)), -.25 * Ro(r * r + 4 * n) + .5 * Ro(i * i + n)]
                }(a * Vo(-1 * t), a * Zo(-1 * t)), s = function (t, e, n) {
                    var i = Do(t), r = ua(Do(e));
                    if (i) {
                        var o = 1 / Zo(i), a = 1 / (qo(i) * qo(i)), u = -(a + n * (r * r * o * o) - 1 + n),
                            s = (-u + aa(u * u - (n - 1) * a * 4)) / 2;
                        return [Ha(No(1 / aa(s)), n) * Wo(t), Ha(No(aa((s / a - 1) / n)), 1 - n) * Wo(e)]
                    }
                    return [0, Ha(No(r), 1 - n) * Wo(e)]
                }(u[0], u[1], i * i);
        ...
        Wa.invert = function (t, e) {
            ...
            }(.5 * Ha(Jo, i * i) - e, -t, i * i), o = function (t, e) {
                var n = e[0] * e[0] + e[1] * e[1];
                return [(t[0] * e[0] + t[1] * e[1]) / n, (t[1] * e[0] - t[0] * e[1]) / n]
            }(r[0], r[1]);
            return [zo(o[1], o[0]) / -1, 2 * No(Ao(-.5 * Ro(n * o[0] * o[0] + n * o[1] * o[1]))) - Jo]
        };
        ra(1 - 1 / 3), Oa(0);
        ...
        Ka.invert = function (t, e) {
            ...
            for (var a = 0; a < 25; a++) {
                var u = Zo(o), s = aa(Vo(o)), c = Zo(o / 2), l = Vo(o / 2), h = Zo(r / 6), p = Vo(r / 6),
        ...
        function ru(t, e) {
            ...
            return [nu * t * (2 * Vo(2 * n / 3) - 1) / iu, 9 * Zo(n / 3) / iu]
        }

        ru.invert = function (t, e) {
            var n = 3 * ra(e * iu / 9);
            return [t * iu / (nu * (2 * Vo(2 * n / 3) - 1)), ra(3 * Zo(n) * nu / 7)]
        };

        function ou(t, e) {
            for (var n, i = (1 + Qo) * Zo(e), r = e, o = 0; o < 25 && (r -= n = (Zo(r / 2) + Zo(r) - i) / (.5 * Vo(r / 2) + Vo(r)), !(Do(n) < Xo)); o++) ;
            return [t * (1 + 2 * Vo(r) / Vo(r / 2)) / (3 * $o), 2 * aa(3) * Zo(r / 2) / aa(2 + $o)]
        }

        ou.invert = function (t, e) {
            var n = e * aa(2 + $o) / (2 * aa(3)), i = 2 * ra(n);
            return [3 * $o * t / (1 + 2 * Vo(i) / Vo(i / 2)), ra((n + Zo(i)) / (1 + Qo))]
        };

        function au(t, e) {
            for (var n, i = aa(6 / (4 + Uo)), r = (1 + Uo / 4) * Zo(e), o = e / 2, a = 0; a < 25 && (o -= n = (o / 2 + Zo(o) - r) / (.5 + Vo(o)), !(Do(n) < Xo)); a++) ;
            return [i * (.5 + Vo(o)) * t / 1.5, i * o]
        }

        au.invert = function (t, e) {
            var n = aa(6 / (4 + Uo)), i = e / n;
            return Do(Do(i) - Jo) < Xo && (i = i < 0 ? -Jo : Jo), [1.5 * t / (n * (.5 + Vo(i))), ra((i / 2 + Zo(i)) / (1 + Uo / 4))]
        };
        ...
        function cu(t, e) {
            ...
            return [Jo * (p + aa(p * p + i * i / l) * r), Jo * (f + aa(d < 0 ? 0 : d) * Wo(-e * o) * r)]
        }

        cu.invert = function (t, e) {
            var n = (t /= Jo) * t, i = n + (e /= Jo) * e, r = Uo * Uo;
            return [t ? (i - 1 + aa((1 - i) * (1 - i) + 4 * n)) / (2 * t) * Jo : 0, ga(function (t) {
        ...
        bu.invert = function (t, e) {
            ...
            do {
                var a = qo(r), u = 1 / Vo(r), s = i - 2 * e * r + r * r;
                r -= n = (a * s + 2 * (r - e)) / (2 + s * u * u + 2 * (r - e) * a)
            } while (Do(n) > Xo && --o > 0);
            return a = qo(r), [(Do(e) < Do(r + 1 / a) ? ra(t * a) : Wo(t) * (oa(Do(t * a)) + Jo)) / Zo(r), r]
        };
        ...
        function xu(t, e) {
            var n, i = Bo(18, 36 * Do(e) / Uo), r = Fo(i), o = i - r, a = (n = Mu[r])[0], u = n[1],
        ...
        Mu.forEach(function (t) {
            ...
            var n = e / Jo, i = 90 * n, r = Bo(18, Do(i / 5)), o = ko(0, Fo(r));
            do {
                ...
                if (f >= 0 || 1 === o) {
                    ...
                    var d, g = 50;
                    do {
                        f = (r = Bo(18, Do(i) / 5)) - (o = Fo(r)), a = Mu[o][1], u = Mu[o + 1][1], s = Mu[Bo(19, o + 2)][1], i -= (d = (e >= 0 ? Jo : -Jo) * (u + f * (s - a) / 2 + f * f * (s - 2 * u + a) / 2) - e) * na
                    } while (Do(d) > Yo && --g > 0);
                    break
                }
            } while (--o >= 0);
        ...
        function Ou(t, e) {
            ...
            if (Do(t) < Xo || Do(Do(e) - Jo) < Xo) return [0, Wo(e) * Uo * qo(i / 2)];
            var r = Vo(i), o = Do(Uo / t - t / Uo) / 2, a = o * o, u = r / (n + r - 1), s = u * (2 / n - 1), c = s * s,
                l = c + a, h = u - c, p = a + u;
            return [Wo(t) * Uo * (o * h + aa(a * h * h - l * (u * u - c))) / l, Wo(e) * Uo * (s * p - o * aa((a + 1) * l - p * p)) / l]
        }
        ...
        Ou.invert = function (t, e) {
            ...
            return [Uo * (r - 1 + aa(1 + 2 * (n - i) + o)) / (2 * t), Wo(e) * Uo * (-h * Vo(p + Uo / 3) - u / (3 * s))]
        };
        ...
        function wu(t, e) {
            ...
            var n = Do(e / Jo), i = ra(n);
            if (Do(t) < Xo || Do(Do(e) - Jo) < Xo) return [0, Wo(e) * Uo * qo(i / 2)];
            var r = Vo(i), o = Do(Uo / t - t / Uo) / 2, a = o * o, u = r * (aa(1 + a) - o * r) / (1 + a * n * n);
            return [Wo(t) * Uo * u, Wo(e) * Uo * aa(1 - u * (2 * o + u))]
        }

        wu.invert = function (t, e) {
            if (!t) return [0, Jo * Zo(2 * No(e / Uo))];
            var n = Do(t / Uo), i = (1 - n * n - (e /= Uo) * e) / (2 * n), r = aa(i * i + 1);
            return [Wo(t) * Uo * (r - i), Wo(e) * Jo * Zo(2 * zo(aa((1 - 2 * i * n) * (i + r) - n), aa(r + i + n)))]
        };
        ...
        function Lu(t, e) {
            ...
            var r = (Uo / t - t / Uo) / 2, o = n / (1 + Vo(i));
            return [Uo * (Wo(t) * aa(r * r + 1 - o * o) - r), Uo * o]
        }

        Lu.invert = function (t, e) {
            if (!e) return [t, 0];
            var n = e / Uo, i = (Uo * Uo * (1 - n * n) - t * t) / (2 * Uo * t);
            return [t ? Uo * (Wo(t) * aa(i * i + 1) - i) : 0, Jo * Zo(2 * No(n))]
        };
        ...
        function Cu(t, e) {
            ...
            var i = n / Jo, r = i * i, o = (8 * i - r * (r + 2) - 5) / (2 * r * (i - 1)), a = o * o, u = i * o,
                s = r + a + 2 * u, c = i + 3 * o, l = t / Jo, h = l + 1 / l, p = Wo(Do(t) - Jo) * aa(h * h - 4),
                f = p * p,
                d = (p * (s + a - 1) + 2 * aa(s * (r + a * f - 1) + (1 - r) * (r * (c * c + 4 * a) + 12 * u * a + 4 * a * a))) / (4 * s + f);
            return [Wo(t) * Jo * d, Wo(e) * Jo * aa(1 + p * Do(d) - d * d)]
        }
        ...
        Cu.invert = function (t, e) {
            ...
            if (!t || !e) return [t, e];
            e /= Uo;
            var i = Wo(t) * t / Jo, r = (i * i - 1 + 4 * e * e) / Do(i), o = r * r, a = 2 * e, u = 50;
            do {
            ...
            return [Wo(t) * (aa(r * r + 4) + r) * Uo / 4, Jo * a]
        };
        ...
        function Gu(t, e) {
            var n = Vo(e), i = Vo(t) * n, r = 1 - i, o = Vo(t = zo(Zo(t) * n, -Zo(e))), a = Zo(t);
        ...
        Du.invert = function (t, e) {
            var n = t, i = e, r = 25;
            do {
                var o, a = Vo(i), u = Zo(i), s = Zo(2 * i), c = u * u, l = a * a, h = Zo(n), p = Vo(n / 2),
        ...
        d.c.registeredClasses.EqualEarth = Hu, window.am4maps = a
    }, QaCB: function (t, e, n) {
        "use strict";
